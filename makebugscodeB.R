...
cat("# Long run consumption frequency:",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# for population: p0",file="bikemodel.txt",sep="\n",append=TRUE)
cat("p0[j] <- p01[j]/(p01[j]+p10[j]) ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("logitp0[j] <- log(p0[j]/(1-p0[j])) ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("}",file="bikemodel.txt",sep="\n",append=TRUE)
