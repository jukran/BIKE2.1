...
if(nf>1){
cat("# Individual consumption amounts can be correlated among food types",file="bikemodel.txt",sep="\n",append=TRUE)
...
if(input$modelchoice3=="Yes"){
cat("# Correlations between food types:",file="bikemodel.txt",sep="\n",append=TRUE)
cat("Ts[1:nf,1:nf] ~ dwish(DI[1:nf,1:nf],nf2s); nf2s<-nf+2",file="bikemodel.txt",sep="\n",append=TRUE)
}
if(input$modelchoice3=="No"){
cat("# No correlations between food types:",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(i in 1:nf){for(j in 1:nf){Ts[i,j]<-equals(i,j)*ts[i] }}",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(i in 1:nf){ts[i] ~ dgamma(1,1)}",file="bikemodel.txt",sep="\n",append=TRUE)
}  
...
cat("# Individual consumption probabilities can be correlated among foods:",file="bikemodel.txt",sep="\n",append=TRUE)
if(nf>1){   
...
cat("}}}",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# Prior for consumption frequencies:",file="bikemodel.txt",sep="\n",append=TRUE)
...
if(nf>1){
cat("#Tp only needed if model includes between-user variability",file="bikemodel.txt",sep="\n",append=TRUE)    
if( (input$modelchoice5=="Yes")&(between.user.pvar==1) ){ 
cat("# Correlations between food types:",file="bikemodel.txt",sep="\n",append=TRUE)
cat("Tp[1:nf,1:nf] ~ dwish(DI[1:nf,1:nf],nf2p); nf2p <- nf+2",file="bikemodel.txt",sep="\n",append=TRUE)
}
if( (input$modelchoice5=="No")&(between.user.pvar==1) ){  
cat("# No correlations between food types:",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(i in 1:nf){for(j in 1:nf){Tp[i,j]<-equals(i,j)*tp[i] }}",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(j in 1:nf){tp[j] ~ dgamma(1,1)}",file="bikemodel.txt",sep="\n",append=TRUE)
}  
